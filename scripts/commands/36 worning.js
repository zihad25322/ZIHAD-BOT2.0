...
module.exports.handleEvent = async ({ event, api }) => {
  ...
  const sensitiveKeywords = ["খানকিমাগি","সাওয়া","khanki","maderxud","xud","xuda","xudi","cuda","cudi","মাগি","মাদারচুদ","চুদ","চুদা","চুদি","ষুদা","bal","খাংকির পোলা","খানকি মাকি","খানকি মাগি","SawYa","Sawya","tor mare xudi","vuda","heda","bap","i will kill you", "i will stab you", "kill you", "stab you", "fuck you", "you idiot", "motherfucker"]; // Dagdagan mo lang kung gusto mong maraming keywords 
    ...
    if (message.includes(keyword)) {
      ...
      try {
        ...
        outputStream.on("finish", () => {
          const warningMessage = `⚠️ 𝗪𝗔𝗥𝗡𝗜𝗡𝗚!\n\nগালাগালি করা ভালো গালাগালি করলে আইডি খাইয়া দিবো 😌 .\n\n  ⦿ 𝗨𝗦𝗘𝗥: ${userName}\n  ⦿ 𝗜𝗗: ${senderID}\n  ⦿ 𝗞𝗘𝗬𝗪𝗢𝗥𝗗: ${keyword}`;
